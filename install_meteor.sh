...
echo "${RELEASE}" | grep -qE "^2\."
if [ $? -eq 0 ] ; then
    echo "This Meteor 2.x version runs on a deprecated Node.js version (14). Meteor 3.0 is now available and supports the latest Node.js version. For details, check the migration guide: https://guide.meteor.com/3.0-migration."
fi
