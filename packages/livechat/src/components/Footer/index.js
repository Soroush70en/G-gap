...
export const PoweredBy = withTranslation()(({ className, t, ...props }) => (
	<h3 className={createClassName(styles, 'powered-by', {}, [className])} {...props}>
		{t('powered_by_rocket_chat').split('G-Gap')[0]}
		<a className={createClassName(styles, 'powered-by__logo')} href='https://chat.golrang.com' target='_blank' rel='noopener noreferrer'>
			<RocketChatLogo />
		</a>
		{t('powered_by_rocket_chat').split('G-Gap')[1]}
	</h3>
));
